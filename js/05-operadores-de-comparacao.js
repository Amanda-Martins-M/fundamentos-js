// Os operadores de comparação são usados para comparar dois valores e SEMPRE retornam um valor booleano - verdadeiro (true) ou falso (false).
...
// Estritamente igual (===) - Comapra valores e tipos de dados.
console.log(a === b);
